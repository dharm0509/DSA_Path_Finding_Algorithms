...
pygame.display.set_caption("Greedy Best First PathFinding Algorithm")  # title
...
def greedy_best_first(draw, grid, start, end):
    ...
    return False
       # couldn't find the path to the end
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE and start and end:
                    ...
                    greedy_best_first(lambda: draw(win, grid, ROWS, width), grid, start, end)
